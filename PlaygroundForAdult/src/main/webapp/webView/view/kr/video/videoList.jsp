...
/* Samsung Galaxy Note4 , LG G3 (landscape) 853X480 */
@media only screen
...
/* Samsung Galaxy Note4 , LG G3 (landscape) 960X540 */
@media only screen
		...
		<div id="homecon" class="row" style=" display: block;">
			<div class="col-12" style="padding: 2%; overflow: scroll; height: 100%;">
				...
				<c:forEach var="video" items="${list}">
					<a href="/webView/view/kr/video/free.jsp?no=${video.no}&title=${video.title}&rt=${video.runningTime}&ex=${video.explain}&id=${member.id}">
