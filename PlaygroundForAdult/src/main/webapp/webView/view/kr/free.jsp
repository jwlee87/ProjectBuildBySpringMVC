...
and (min-device-width : 360px) {
	...
	#title {font-size: 15px; font-weight: bold; margin:auto;}
	#explain {font-size: 15px;}
	#rt {font-size: 12px; margin: -40px 0 0 15px;}
...
and (min-device-width : 641px) {
	...
	#exit_btn{height: 30px; margin: 0 0 0 15px;}
	#playBtn {height: 30px; margin: -85px 0 0 2px;}
}
...
and (orientation : landscape) {
	...
	#title {font-size: 22px; font-weight: bold; margin:auto;}
	#explain {font-size: 16px;}
	#rt {font-size: 15px; margin: -55px 0 0 10px;}
	#exit_btn{height: 30px; margin: 0 0 0 30px;}
	#playBtn {height: 60px; margin: -85px 0 0 -15px;}
}
...
and (orientation : landscape) {
	...
	#title {font-size: 30px; font-weight: bold; margin:auto;}
