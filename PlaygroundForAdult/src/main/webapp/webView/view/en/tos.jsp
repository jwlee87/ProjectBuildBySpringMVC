...
<div class="container-fluid">
 ...
 이 약관은 ㈜ King of Day (이하 ‘회사’)가 제공하는 모바일게임 서비스 이용과 관련하여 회사와 이용자 간의 권리와
 의무 및 필요한 제반 사항을 규정함을 그 목적으로 합니다.
 ...
 1. “이용자”란 회사의 약관에 동의하고 회사의 정보를 지속적으로 제공받으며 회사가 제공하는 서비스를 지속적으로 이용할
 수 있는 자를 의미하고, “임시이용자”란 정식으로 “이용자”로 가입하지 아니하고 게스트로그인 모드를 이용하는 자를 의미합니다.
 
 2. “서비스”란 회사가 제공하는 모바일게임 및 기타 서비스 일체를 의미합니다.
 ...
 5. "오픈마켓사업자"란 당사 게임을 설치하고 결제할 수 있도록 기능을 제공하는 전자상거래 업체(게임 내 결제를 제공하는 사업자 포함)를 의미합니다.(예: 구글 플레이 앱스토어, 애플 앱스토어, 티스토어, 
 올레마켓, 유플러스 앱마켓 등)
 6. "플랫폼사업자"란 당사 게임을 알리거나 이용함에 있어서 회사와 제휴하여 서비스를 제공하는 사업자를 의미합니다.(예, 카카오, 라인 등)
 7. "계정정보"란 이용자의 ID, 게임 회원번호, 기기정보, 별명, 프로필 사진, 친구목록 등 이용자가 회사에 제공한 일반정보 및 게임이용정보(캐릭터 정보, 아이템, 레벨 등), 이용요금 결제정보 등의 생성정보를 
 의미합니다. 
 ...
 4. 변경된 약관은 변경된 약관 적용일 7일 전에(다만, 이용자의 권리?의무에 중대한 영향을 미치는 사항에 대하여는 30일전) 회사의 웹사이트나 공식 카페, 제공하는 애플리케이션 등을 통해 이용자에게 고지하고 
 적용일부터 효력이 발생합니다.
 5. 이용자는 변경된 약관에 대해 동의하지 않을 권리가 있으며, 변경된 약관에 동의하지 않을 경우에는 애플리케이션 로그아웃 및 삭제와 함께 서비스 이용을 중단하고 탈퇴할 수 있습니다. 다만, 회사가 변경된 
 약관을 고지하면서 이용자에게 적용일 전까지 거부의 의사표시를 하지 않으면 약관 변경에 동의한 것으로 간주한다는 뜻을 명확히 하였음에도 불구하고 이용자가 거부의 의사표시를 하지 아니하는 경우에는 변경된 
 약관에 동의한 것으로 간주합니다. 
 ...
 4. 회사는 계속적이고 안정적인 서비스의 제공을 위하여 서비스 개선을 하던 중 설비에 장애가 생기거나 데이터 등이 멸시된 때에는 천재지변, 비상사태, 해결이 곤란한 기술적 결함 등 부득이한 사유가 없는 한 이를 
 ...
 8. 회사로부터 특별한 권리를 부여 받지 않고 애플리케이션을 변경하거나 애플리케이션에 다른 프로그램을 추가 또는 삽입하거나 서버를 해킹, 역설계하거나 소스코드나 애플리케이션 데이터의 유출 및 변경, 별도의
  서버를 구축하거나 웹사이트의 일부분을 임의로 변경 또는 도용하여 회사를 사칭하는 행위
 ...
 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을원칙으로 합니다. 단, 정기점검 등의 필요에 의해 회사가 정한 날이나 시간에는 서비스를 일시 중단할 수 있으며 회사는 
 그 시간대나 날짜를 미리 웹사이트나 애플리케이션 내에 공지합니다.
	
	
 제8조 [서비스 내용 및 변경]


 1. 회사는 새로운 게임 내용, 각종 버그 패치 등 서비스의 운영상, 기술상 또는 기획상 필요한 경우, 제공하고 있는 서비스의 전부 또는 일부를 상시적으로 수정, 추가, 폐지 등 변경할 수 있습니다. 변경될 서비스의 
 내용 및 제공일자 등에 대해서는 운영하는 웹사이트 또는 애플리케이션 내에 게시하여 통지합니다. 
 ...
 정보제공 및 제2항의 광고 등을 제공하는 경우 SMS(LMS), 스마트폰 알림(Push 알림), 메일주소 등을 활용하여 발송할 수 있으며, 이용자가 원하지 않는 경우에는 언제든지 수신을 거부할 수 있습니다
 

 제10조 [유료콘텐츠의 구매 및 이용]


 1. 이용자는 서비스를 사용하고 있는 단말기의 종류에 따른 각 오픈마켓사업자의 결제 운영정책에 따라 유료콘텐츠를 구매할 수 있으며, 해당 결제 정책의 차이로 인해 결제금액 한도액의 차이가 발생할 수 있습니다. 
 또한 유료콘텐츠의 구매대금은 오픈마켓사업자와 연계된 이동통신사나 플랫폼사업자 또는 오픈마켓사업자가 정하는 방법 및 정책에 따라 부과되며, 납부방식 역시 해당 사업자의 정책을 따릅니다.
 ...
 2. 이용자는 단말기의 비밀번호 설정 기능, 오픈마켓에서 제공하는 비밀번호 설정 기능 등을 이용하여 제3자의 In-App결제를 방지하여야 하며, 회사는 이를 위하여 방송통신위원회의 권고 및 「오픈마켓모바일콘텐츠
 결제가이드라인」에 따라 오픈마켓이 제공하는 인증절차 등이 적용된 In-App결제를 위한 모듈, 라이브러리 등을 애플리케이션에 적용합니다.
 ...
 1. 이용자가 구매한 유료콘텐츠의 경우에는 계약체결일 또는 유료콘텐츠 이용가능일로부터 7일 이내에 별도의 수수료 없이 청약철회(구매취소)를 할 수 있습니다. 단, 선물 및 이벤트 등 회사나 제3자로부터 무상으로 
 제공받은 유료콘텐츠 또는 청약철회 요청 당시 이미 사용하였거나 사용한 것으로 간주되는 유료콘텐츠 등 이에 준하는 특성을 가진 일부 유료콘텐츠에 대하여는 「전자상거래등에서의소비자보호에관한법률」 
 제17조 제2항 제2호 내지 제3호 및 「콘텐츠산업진흥법」 제27조 제1항에 따라 청약철회(구매취소)가 제한될 수 있습니다. 이 경우 회사는 이용자에 대하여 해당 유료콘텐츠 구매 시 고지하는 등 관련 법률에서 정한 바에
  따른 조치를 취하기로 합니다.
 2. 이용자가 회사의 고의 또는 중대한 과실에 따른 귀책사유로 인하여 구매한 유료콘텐츠를 이용하지 못하는 경우, 동일한 유료콘텐츠를 무상으로 제공하거나 해당 구매 금액을 계약체결일(구매일)에 관계없이 전액 
 환불합니다. 다만 서비스를 중단하는 경우에는 제8조 제2항에 의하여 처리합니다.
 3. 환불은 납부 확인이 된 경우에 한해 신청일로부터 3영업일 이내 구매한 결제수단으로 환불함을 원칙으로 합니다. 단, 서비스를 사용하고 있는 단말기의 운영체제 종류에 따라 각 오픈마켓사업자의 환불 운영정책이
  적용될 수 있으며, 자세한 환불 신청 절차는 회사 웹사이트 또는 애플리케이션 내에 공지된 바에 따릅니다. 또한 환불이 된 대가에 따라 게임 내 유료콘텐츠는 해당 환불된 금액만큼 차감 반영합니다.
 4. 유료콘텐츠를 개봉(예: 보관함에서 이동시킨 경우 등)하거나 사용하기 버튼을 클릭한 경우에는 이용자가 사용 의사를 밝힌 것으로 판단할 수 있으며, 또한 전체 혹은 일부 사용으로 인하여 게임 서비스 내에서 구매
 할 수 있는 기본 단위가 훼손되었을 시에도 회사는 이용자가 사용 의사를 밝힌 것으로 판단합니다. 또한 메시지함 및 선물함 등 유료콘텐츠의 송수신과 관련된 화면에서 수락 등의 동의 과정을 거친 경우 이는 이용자가 
 사용 의사를 밝힌 것으로 판단합니다. 해당 사항은 고객의 의도와 상이하게 타인을 통해 구매되었을 경우도 포함합니다.
 5. 이용자가 실제 정상적인 구매내역이 기록되는 이용대금의 결제를 통하지 않고 게임 서비스 중에 보상으로 취득하거나, 회사가 내부 이벤트 혹은 외부 제휴 이벤트 등을 통하여 지급한 콘텐츠는 환불되지 않습니다.
 6. 청약철회 및 환불 등을 요구할 경우에는 회사 고객센터 또는 회사가 지정한 위탁업체에 별도의 개인정보 취급에 대한 동의 과정을 거친 후 회사의 구매내역 확인에 의해 진행되며, 이 과정 중 플랫폼사업자, 오픈마켓
 사업자를 통해 구매내역을 확인하는 절차를 거친 다음 진행됩니다. 회사는 이 과정 중에서 이용자의 정당한 청약철회 사유를 확인하기 위해 이용자에게서 제공받은 정보를 통해 이용자에게 연락하여 정확한 사실 확인
 	을 할 수 있으며, 추가적으로 증빙을 요구할 수 있습니다.(예: 플랫폼사업자에 등록된 개인정보, 오픈마켓사업자의 구매 또는 결제내역, 고객의 의도와 상이하게 타인을 통해 구매되었다는 것을 확인할 수 있는 서류
 &lt;예: 가족관계 증명서&gt; 등)
 ...
 8. 애플리케이션에서 판매되는 유료콘텐츠를 미성년자가 법정대리인의 동의 없이 In-App결제한 경우, 미성년자 또는 법정대리인은 In-App결제를 취소할 수 있습니다. 단, 미성년자의 In-App결제가 법정대리인으로부터
  처분을 허락 받은 재산의 범위 내인 경우 또는 미성년자가 사술 등을 사용하여 성년자로 믿게 한 때에는 취소가 제한됩니다. 유료콘텐츠의 구매자가 미성년자인지 여부는 In-App결제가 진행된 단말기 또는 신용카드 등 
 결제수단의 명의자를 기준으로 판단됩니다. 결제취소를 요청하시는 경우 회사의 필요에 따라 미성년자 및 법정대리인을 증명할 수 있는 서류를 제출하여야 합니다.
 9. 선물하기 기능을 통하여 이루어진 In-App결제에 대하여는 구매한 유료콘텐츠에 하자가 있는 경우를 제외하고는 원칙적으로 결제취소 및 환급이 불가하며, 유료콘텐츠의 하자로 인한 환급은 선물을 보낸 이용자에 
 한하여 가능합니다.
 ...
 1. 회사의 귀책사유로 과오금이 발생한 경우 과오금을 이용자에게 환불합니다. 단, 이용자의 귀책사유로 과오금이 발생한 경우에는 회사가 과오금을 환불하는 데 소요되는 비용을 합리적인 범위 내에서 이용자에게 
 부담하도록 할 수 있습니다. 
 2. 환불절차는 오픈마켓사업자가 제공하는 방식을 따릅니다. 따라서 과오금이 발생한 경우, 이용자는 원칙적으로 오픈마켓사업자에 대하여 환급을 요청하거나, 추가 결제를 하여야 합니다. 단, 회사는 오픈마켓사업자의
 정책, 시스템에 따라 가능한 경우 회사가 오픈마켓사업자를 대신하여 위와 같은 절차를 대행할 수도 있습니다
 ...
 2. 회사가 제3자와 제휴 계약을 맺고 이용자에게 개별서비스를 제공함에 있어 이용자가 제3자의 이용약관에 동의를 한 뒤 개별서비스 제공자의 귀책 사유로 인해 손해가 발생할 경우 관련 손해에 대해서는 제3자가 책임을 
 집니다.
 3. 이용자가 서비스를 이용함에 있어 행한 불법행위나 이 약관 위반행위로 인하여 회사가 당 이용자 이외에 제3자로부터 손해배상 청구 또는 소송을 비롯한 각종 이의제기를 받는 경우, 당 이용자는 자신의 책임과 비용으로 
 회사를 면책시켜야 하며, 회사가 면책되지 못하는 경우 당 이용자는 그로 인해 회사에 발생한 모든 손해를 배상할 책임이 있습니다.
 ...
 2. 회사는 이용자의 귀책사유로 인한 서비스의 중지/이용장애에 대하여 책임을 지지 아니하며, 회사는 기간 통신 사업자 등이 전기통신서비스 등을 중지하거나 정상적으로 제공하지 아니하여 이용자에게 손해가 발생한 
 경우에 대해서는 책임이 면제됩니다.
 3. 회사는 사전에 공지되거나 긴급하게 실시된 서비스용 설비의 보수, 교체, 정기점검, 공사 등 부득이한 사유로 서비스가 중지되거나 장애가 발생한 경우에 대해서 회사의 고의 또는 중대한 과실이 없는 한 책임이 면제됩니다.
 4. 회사는 이용자가 서비스를 이용하여 기대하는 점수, 순위 등을 얻지 못한 것에 대하여 책임을 지지 않으며 서비스에 대한 취사 선택 또는 이용으로 발생하는 손해 등에 대해서는 회사의 고의 또는 중대한 과실이 없는 
 한 책임이 면제됩니다.
 ...
 10. 회사는 관련 법령, 정부 정책 등에 따라 게임서비스 또는 회원에 따라 게임 서비스 이용시간 등을 제한할 수 있으며, 이러한 제한사항 및 제한에 따라 발생하는 게임 서비스 이용 관련 제반사항에 대해서는 책임이 면제
 됩니다.
 11. 회사는 ”임시이용자”가 정식으로 “이용자”로 가입하지 아니하고 회사의 서비스를 이용함에 따라 발생될 수 있는 모든 문제에 대하여 책임을 지지 아니합니다.  “임시이용자”로 서비스를 이용하는 경우 다음 각호의 
 사유가 발생시 서비스 이용기록 및 거래기록이 삭제되거나 기록을 확인할 수 없는 문제가 발생할 수 있습니다. 따라서, “회사”는 이러한 사실에 대해 최초 서비스 이용 시 팝업 등으로 알려드릴 것입니다. 또한, 제3자가 
 “임시이용자”의 단말기 정보를 부정하게 조작, 이용하여 서비스를 이용함에 따른 결과에 대하여도 회사는 책임을 지지 않습니다. 
 	1. 모바일 기기를 변경한 경우
 ...
 2. CBT는 해당 게임 서비스의 안정성 등을 위해 게임 데이터의 변경, 추가, 삭제 등이 실시될 수 있으며, 이와 관련하여 복구, 이용시간 연장, 손해배상 등 일체의 보상은 진행되지 아니합니다. 또한 CBT 기간 동안 
 이용자가 취득한 아이템, 게임머니, 캐릭터 등은 기간 종료 후 초기화됩니다.
 ...
 1. 개인정보의 처리 목적 (‘http://www.kingofday.co.kr/’이하 ‘KingofDay’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
 ...
 ① (‘http://www.kingofday.co.kr/’이하 ‘KingofDay’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유?이용기간 또는 법령에 따른 개인정보 보유?이용기간 내에서 개인정보를 처리?보유합니다.
 ...
 (‘http://www.kingofday.co.kr/’이하 ‘KingofDay) 은(는) 정보주체의 별도 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우 외에는 개인정보를 제3자에게 제공하지 않습니다.



 4. 개인정보처리 위탁

 ① ('KingofDay')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

 - 위탁받는 자 (수탁자) : (주)킹오브데이
 - 위탁하는 업무의 내용 : 구매 및 요금 결제, 본인인증(금융거래, 금융서비스), 회원제 서비스 이용에 따른 본인확인, 불만처리 등 민원처리, 이벤트 및 광고성 정보 제공 및 참여기회 제공
 - 위탁기간 : 1년


 ② ('http://www.kingofday.co.kr/'이하 'KingofDay')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적?관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리?감독, 
 ...
 ① ('http://www.kingofday.co.kr/'이하 'KingofDay')은(는) 다음의 개인정보 항목을 처리하고 있습니다.

 - 필수항목 : 이메일, 휴대전화번호, 비밀번호 질문과 답, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 취미, 주민등록번호, 은행계좌정보, 서비스 이용 기록, 접속 IP 정보, 결제기록
 - 선택항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 은행계좌정보, 서비스 이용 기록, 접속 로그, 접속 IP 정보, 결제기록



 7. 개인정보의 파기('KingofDay')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.

 -파기절차이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다. 이 때, DB로 옮겨진 개인정보는 법률에
   의한 경우가 아니고서는 다른 목적으로 이용되지 않습니다.-파기기한이용자의 개인정보는 개인정보의 보유기간이 경과된 경우에는 보유기간의 종료일로부터 5일 이내에, 개인정보의 처리 목적 달성, 해당 서비스의 폐지, 
   사업의 종료 등 그 개인정보가 불필요하게 되었을 때에는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 5일 이내에 그 개인정보를 파기합니다.



 8. 개인정보의 안전성 확보 조치 ('KingofDay')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
 ...
 4. 해킹 등에 대비한 기술적 대책
 &lt;(주)킹오브데이&gt;('KingofDay')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신?점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 
 ...
 ① (주)킹오브데이(‘http://www.kingofday.co.kr/’이하 ‘KingofDay) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
 ...
 ▶ 개인정보 보호책임자
    ...
    연락처 :02.536.1300, kingofdayinc@gmail.com, 02.536.1301
    ※ 개인정보 보호 담당부서로 연결됩니다.
 ...
 ▶ 개인정보 보호 담당부서
     ...
     담당자 :
     연락처 :, ,
    ② 정보주체께서는 (주)킹오브데이(‘http://www.kingofday.co.kr/’이하 ‘KingofDay) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. (주)킹오브데이(‘http://www.kingofday.co.kr/’이하 ‘KingofDay) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
