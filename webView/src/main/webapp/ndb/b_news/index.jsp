...
table tbody tr td {overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}
...
<div class="container-fluid">
	...
	<tr>
        <td>${news.uniqueID}</td>
        <td><a href="/ndb/b_news/jsp/${pageResult.page}/${news.uniqueID}">${news.title}</a></td>
        <td style="font-size: 0.8em;"><fmt:formatDate value="${news.genDate}" pattern="MM/dd hh:mm"/></td>
	</tr>
	</c:forEach>
