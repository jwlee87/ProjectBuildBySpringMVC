...
and (min-device-width : 400px) {
	.container-fluid {width: 578px; height: 310px; background-image: url("/webView/img/568x320/bg_without.png"); background-repeat: no-repeat; overflow-y: hidden; overflow-x: hidden; margin: 0; padding: 5px;}
	#logo {width: 70%; margin: 20px auto 0 auto;}
	#idBtn {font-size: 20px; font-weight: bold;}
	#passBtn {font-size: 20px; font-weight: bold;}
}

/* Samsung Galaxy S7 (landscape) 640X360 */
@media only screen
...
and (min-device-width : 569px) {
	...
	#logo {width: 350px; margin: 50px auto 0;}
	#idBtn {font-size: 20px; font-weight: bold;}
	#passBtn {font-size: 20px; font-weight: bold;}
}
...
and (min-device-width : 641px) {
	...
	#logo {width: 420px; margin: 50px auto 0;}
	#idBtn {font-size: 20px; font-weight: bold;}
	#passBtn {font-size: 20px; font-weight: bold;}
}
...
.contentcon {height: 100%; overflow-y: hidden; margin: 5px 5px;}
