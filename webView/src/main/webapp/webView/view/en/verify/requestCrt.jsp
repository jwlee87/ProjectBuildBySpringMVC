...
<body>
<!-- 본인인증서비스 요청 form --------------------------->
<div class="maincon" style="text-align: center;">
	<form name="reqKMCISForm" method="post" action="#" style="width: 100%; margin: 20% auto;">
	    ...
	    <input type="submit" value="성인인증"  onclick= "javascript:openKMCISWindow();">
	</form>
</div>
...
$(window).on("load", function(){
	...
	$("#maincon").css("width", $(window).width()-30);
	$("#maincon").css("height", $(window).height());
	$(window).resize(function(){
		$("#maincon").css("width", $(window).width()-20);
		$("#maincon").css("height", $(window).height());
	})
})
