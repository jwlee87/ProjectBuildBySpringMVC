...
and (min-device-width : 570px) {
	...
	#player{height: 360px; overflow: hidden;}
}
...
and (min-device-width : 741px) {
	...
	.absolute{position: fixed; top: 5px; right: 5px;}
	.absolute img {width: 30px;}
	#player{height: 480px; overflow: hidden;}
}
...
and (min-device-width : 854px) {
	...
	.absolute{position: fixed; top: 5px; right: 5px;}
	.absolute img {width: 30px;}
	#player{height: 540px; overflow: hidden;}
}
...
and (orientation : landscape) {
	...
	.absolute{position: fixed; top: 5px; right: 5px;}
	.absolute img {width: 30px;}
	#player{width: 1000px; overflow: hidden;}
}
...
and (orientation : landscape) {
	...
	.absolute{position: fixed; top: 5px; right: 5px;}
	.absolute img {width: 30px;}
	#player{width: 1200px; overflow: hidden;}
}
</style>
</head>
<body class="container-fluid">
	<video id="player" style="margin: 0 auto;" controls controlsList="nodownload" autoplay
		poster="/webView/video/jp/thumnail/${param.no}_thumnail.png">>
		<source src="/webView/video/jp/bm_j_${param.no}.mp4" type="video/mp4">
	</video>
	<div class="absolute">
